  ...
  <!-- Main content -->
      <section class="content">
                ...
                <form role="form" action="" method="post" >
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control" name="Employ_Id" id="Employ_Id" value="<?php echo $data['employ_id']; ?>" >
                    </div>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="view_faculty.php" class="btn btn-warning float-right">Back</a>
                    </div>
                   </form>
                          </div>
                        </div>
        ...
        <?php
                    ...
                    text: "Faculty account activated.",
                    type: "success",
