          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Viwe Student</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $sqli =" SELECT * FROM `registerpage` WHERE `type`='student' AND `aprove`= 0" ;
                      ...
                      while ($row = $data->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><center><?php echo $row['email_id']; ?></center></td>
                              <td><center><a href="aprove_student.php?id=<?php echo base64_encode($row['id']); ?>" class="nav-link ">
