  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View Question (MCQ Based)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  ...
                  <?php
                  $sqlii =" SELECT * FROM `question` WHERE `ex_id`='$id' AND `que_type`='mcq'";
                  ...
                  if($dataa->num_rows>0){
                    ...
                    while ($roww = $dataa->fetch_assoc()) {
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="float-right">
                          <a href="edit-mcq.php?question_id=<?php echo base64_encode($roww['id']); ?>"><i class="fa fa-edit dred"></i></a>
                          <a href="delete-mcq.php?question_id=<?php echo $roww['id']; ?>"><i class="fa fa-trash pink"></i></a>
                        </div>
                        <?php endif; ?>
                      </div>
                      <?php
